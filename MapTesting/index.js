    ...
    vehicles: [
        {
            ...
            start_address: { location_id: "Bãi xe", lon: 106.664658, lat: 10.847044 }
        }
    ],
    vehicle_types: [
        { type_id: "custom_vehicle_type", profile: "car" }
    ],
    services: [
        {
            id: "1",
            name: "2",
            address: { location_id: "132 Lê Văn Thọ", lon: 106.657142, lat: 10.844348 }
        },
        {
            id: "2",
            name: "2",
            address: { location_id: "435 Lê Đức Thọ", lon: 106.674036, lat: 10.843802 }
        },
        {
            id: "3",
            name: "3",
        ...
        },
        {
            id: "4",
            name: "4",
            address: { location_id: "1043 Lê Đức Thọ", lon: 106.661639, lat: 10.851777 }
        }
    ]
}
